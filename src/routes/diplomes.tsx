      ...
      <Page>
        <section className="px-6 py-20 mx-auto max-w-6xl">
          ...
          <p className="text-center text-ivory mt-8 max-w-3xl mx-auto font-italic-serif text-lg">
            Ces praticiens ont été formés, initiés et diplômés par KINWAHO HOUNGUEVI DJIMA. Ils sont
            aujourd'hui actifs dans le domaine de la tradition vodoun.
          </p>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
            {(graduates ?? []).map((g) => (
              <div key={g.id} className="sacred-card text-center">
                ...
                <p className="mt-4 text-xs uppercase tracking-widest text-gold border border-gold/40 rounded-sm py-1 px-2 inline-block">
                  Diplômé par Hounon Propre ✓
                </p>
              </div>
            ))}
          </div>
