  ...
  head: () => ({
    meta: [
      { title: "Hounon Propre — Maître Spirituel Vodoun & Guérisseur Traditionnel" },
      {
        name: "description",
        content:
          "KINWAHO HOUNGUEVI DJIMA. Consultations, rituels, guérison, formations. Bénin & monde entier.",
      },
    ],
  }),
  component: HomePage,
    ...
    <Page>
      ...
      <section className="hero-glow relative min-h-[90vh] flex items-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl grid md:grid-cols-2 gap-12 items-center py-20">
          <div className="fade-up text-center md:text-left">
            <p className="font-italic-serif text-gold tracking-widest text-sm mb-4 inline-flex items-center gap-2 justify-center md:justify-start">
              — Bénin{" "}
              <img
                src={flagBenin}
                alt="Bénin"
                className="h-3 w-auto rounded-[1px] inline"
                style={{ width: 20 }}
              />{" "}
              & Monde Entier —
            </p>
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl gold-text mb-3 leading-tight">
              HOUNON PROPRE
            </h1>
            ...
            <p className="text-sand mb-8 text-sm uppercase tracking-widest">
              Maître Spirituel & Guérisseur Traditionnel Vodoun
            </p>
          ...
          <div className="fade-up flex justify-center" style={{ animationDelay: "0.3s" }}>
            <div
              className="pulse-ring w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-2 border-gold/50"
          ...
          {[
            {
              ...
              text: "Rituels, consultations et guérisons disponibles dans le monde entier.",
            },
            {
              icon: "📚",
              title: "Formations",
              text: "Apprenez les savoirs ancestraux et obtenez votre diplôme reconnu.",
            },
            {
              icon: "🌍",
              title: "Livraison à Distance",
              text: "Vos préparations livrées dans n'importe quel pays du monde.",
            },
          ].map((p) => (
      ...
      <section className="px-6 py-16 mx-auto max-w-5xl text-center">
        ...
        <p className="text-ivory mt-8 max-w-3xl mx-auto leading-relaxed">
          Héritier d'une longue lignée de prêtres vodoun, Hounon Propre détient les attributs sacrés
          du Houn — cette entité invisible qui permet d'intercéder auprès des ancêtres divinisés
          pour sauver et guérir les êtres humains.
        </p>
        <Link to="/biographie" className="btn-outline mt-8">
          En savoir plus
        </Link>
      </section>
      ...
      <section className="px-6 py-16 mx-auto max-w-6xl">
        ...
        <p className="text-sand text-center max-w-3xl mx-auto mt-6 font-italic-serif text-lg">
          Hounon Propre est consacré à plusieurs divinités vodoun dont les pouvoirs guident chacune
          de ses interventions. Parmi eux :
        </p>
          ...
          {(vodouns ?? []).map((v) => (
            ...
            >
              ...
              <div className="p-5 flex-1">
                ...
                {v.subtitle && (
                  <p className="font-italic-serif text-sand text-xs mb-2">{v.subtitle}</p>
                )}
        ...
        <p className="text-center text-sand font-italic-serif mt-8">
          et plusieurs autres divinités sacrées…
        </p>
        <div className="text-center mt-6">
          <Link to="/biographie" hash="vodouns" className="btn-outline">
            Voir tous les Vodouns
          </Link>
        </div>
      </section>
      ...
      <section className="relative px-6 py-20 mt-16 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <p className="font-italic-serif text-xl text-ivory mb-8">
            Hounon Propre vous accompagne à distance. Livraison de préparations dans tous les pays.
            Consultations par WhatsApp.
          </p>
          <Link to="/contact" className="btn-primary">
            Prendre Rendez-vous
          </Link>
